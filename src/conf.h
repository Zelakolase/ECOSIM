...
const double bound_greed_multiplier = 0.2;
const double origin_y = 0.0;
const double bound_y = 0.6;
...
const int init_raw_materials = 100; // starting raw materials for all cmps
const double food_energy_multiplier = 5; // obvious function
const double luxury_energy_multiplier = 3.5; // ~
