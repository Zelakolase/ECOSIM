...
const double init_wealth = 10; // starting wealth for cmps, emps
...
const double init_energy = 100; // starting energy level for emps
...
const double luxury_energy_multiplier = 2; // ~
