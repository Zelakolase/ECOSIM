...
const double init_energy = 10000; // starting energy level for emps
...
const int init_raw_materials = 10000; // starting raw materials for all cmps
const double food_energy_multiplier = 10; // obvious function
const double luxury_energy_multiplier = 14; // ~
