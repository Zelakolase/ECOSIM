...
const double init_wealth = 1000; // starting wealth for cmps, emps
const double init_price = 0.5; // starting price for all products
const double init_price_multiplier = 1; // starting price multiplier for all cmps
const double origin_greed_multiplier = 0.0;
const double bound_greed_multiplier = 0.1;
const double origin_y = 0.0;
const double bound_y = 0.3;
...
const int iterations = 200; // num of model iterations
const int luxury_dependency = 2; // number of food units required for each luxury unit
const int init_raw_materials = 1000; // starting raw materials for all cmps
const double food_energy_multiplier = 5; // obvious function
...
const double fear_sensitivity_bound = 0.75; // Y factor increase if food consumption exceeds 'fear_sensitivity_bound' of the total salary
const double fear_sensitivity_origin = 0.2; // Y factor decrease if food consumption didn't exceed 'fear_sensitivity_origin' of the total salary
#endif